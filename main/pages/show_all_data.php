...
$damkar = new damkar();
$laporan_list = $damkar->laporan_list();
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Daftar Seluruh Permohonan</h1>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-12">
              <div class="card card-navy">
                <div class="card-header">
                  <h3 class="card-title">Daftar Seluruh Permohonan</h3>
                </div>
                <div class="card-body">
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              ...
                              ?>
                              <a href="<?php echo $nav_link; ?>?ex=<?php echo session_id(); ?>&id=<?php echo $row['id_permohonan']; ?>" type="button" class="btn btn-sm btn-block btn-info"><i class="fas fa-info-circle"></i> Detail</a>
                            </td>
                          </tr>
                      <?php
                        }
...
<div class="modal fade" id="modalLaporan<?php echo $row['id_permohonan']; ?>">
        ...
        <table class="table table-striped table-bordered">
          ...
          <tr>
            ...
            <td><img src="files/foto_pelaporan/<?php echo $permohonan_detail['foto_1']; ?>" width="40%">
              ...
              <img src="files/foto_pelaporan/<?php echo $permohonan_detail['foto_3']; ?>" width="40%">
            </td>
          </tr>
          <tr>
