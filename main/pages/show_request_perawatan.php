...
<?php
  ...
  $damkar = new damkar();
  $perawatan_list = $damkar->perawatan_list();
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daftar Permohonan Perawatan</h1>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="card card-navy">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    $no = 1;
                    if ($perawatan_list == "No Data"){
                      echo "";
                    }
                    else {
                    foreach($perawatan_list as $row) {
                  ?>
                  <tr>
                    <td><?php echo $no++ ?></td>
                    ...
                    <td><?php echo $row['deskripsi_kerusakan']; ?></td>
                    <td>
                      <?php
