  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daftar Admin Kantor Cabang</h1>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="card card-navy">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><img src="files/user_photo/<?php echo $row['user_photo']; ?>" width="50" height="60"></td>
                    <td><?php echo $row['user_nip']; ?></td>
                    <td><?php echo $row['user_name']; ?></td>
                    <td>
                      <?php
                      if($row['user_gender'] == "P"){
                        echo "Pria";
                      }
                      else{
                        echo "Wanita";
                    ...
                    <td>
                      <?php
                        $nav_link = "show_user_detail.php"
                      ?>
                      <a href="<?php echo $nav_link; ?>?ex=<?php echo session_id(); ?>&id=<?php echo $row['user_nip']; ?>" type="button" class="btn btn-sm btn-block btn-info"><i class="fas fa-info-circle"></i> Detail</a></td>
                  </tr>
                  <?php
                    }}
                  ?>
