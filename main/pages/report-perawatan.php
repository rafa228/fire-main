...
$pdf->Cell(0,7,'DATA PERAWATAN',0,1,'C');
...
$pdf->Cell(30,10,'Tgl. Permohonan',1,0,'C');
...
$hasil = mysqli_query($kon, "SELECT * from db_permohonan WHERE jenis_pelaporan = 'Perawatan' order by id_permohonan ASC");
while ($data = mysqli_fetch_array($hasil)){
    $pdf->Cell(8,6,$no,1,0);
    $pdf->Cell(30,6,$data['tgl_pelaporan'],1,0, 'C');
    $pdf->Cell(25,6,$data['jenis_pelaporan'],1,0,'C');
    $pdf->Cell(40,6,$data['kantor_cabang'],1,0);
    $pdf->Cell(70,6,$data['nama_alat'],1,0);
