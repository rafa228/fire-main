          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="detail_pelaporan.php?ex=<?php echo session_id(); ?>&id=<?php echo $row['id_permohonan']; ?>" type="button" class="btn btn-sm btn-block btn-info"><i class="fas fa-info-circle"></i> Detail</a></td>
              </tr>
              <?php
                }
              }
